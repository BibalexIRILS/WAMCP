...
/**
 * Class represents particle node of type ALL
 * 
 */
@SuppressWarnings("serial")
public class SugtnAllNode extends SugtnParticleNode {
	
	/**
	 * Constructs a particle node of type ALL and sets user object to "All"
	 */
	SugtnAllNode() {
		super();
