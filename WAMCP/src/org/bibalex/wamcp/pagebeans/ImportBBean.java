...
public class ImportBBean extends WAMCPRequestBBean implements IDTActionListener, // Callable<Void>,
		Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 7314402764002641839L;
	...
	public void doImport(ActionEvent ev) {
		try {
			...
			outputter.output(this.xmlDoc, new FileOutputStream(URLPathStrUtils.appendParts(
					this.storage.getUserDir().getCanonicalPath(), "Imported.XML")));
			...
			this.storage.createFromDocument(this.xmlDoc, this.shelfmark, this.albumName,
					this.albumCaption, this.albumCoverName);
...
// String instXPStr = xsaInst.getXPathToAllOccsInAllConts();
	...
	public void setAlbumCoverName(String albumCoverName) {
